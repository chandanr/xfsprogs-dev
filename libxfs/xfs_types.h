...
typedef uint16_t	xfs_aextnum_t;	/* # extents in an attribute fork */
...
#define	MAXEXTNUM	((xfs_extnum_t)0xFFFFFFFF)	/* signed int */
#define	MAXAEXTNUM	((xfs_aextnum_t)0xFFFF)		/* signed short */
