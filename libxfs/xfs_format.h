...
#define XFS_SB_FEAT_INCOMPAT_EXTCOUNT_64BIT	(1 << 4) /* 64-bit inode fork extent counters */
...
typedef struct xfs_dinode {
	...
	__be32		di_nextents32;	/* lower part of data fork extent count */
	__be16		di_nextents16;/* lower part of attr fork extent count */
...
#define XFS_IFORK_EXTCNT_MAXU64	((uint64_t)0xffffffffffff) /* Unsigned 48-bits */
