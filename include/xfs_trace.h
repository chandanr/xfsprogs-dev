...
#define trace_xfs_log_grant_wake_up(...) ((void)0)
#define trace_xfs_log_grant_sleep(...) ((void)0)
#define trace_xfs_log_grant_wake(...) ((void)0)
#define trace_xfs_log_regrant(...) ((void)0)
#define trace_xfs_log_regrant_exit(...) ((void)0)
#define trace_xfs_log_reserve(...) ((void)0)
#define trace_xfs_log_reserve_exit(...) ((void)0)
#define trace_xlog_iclog_release(...) ((void)0)
#define trace_xlog_iclog_syncing(...) ((void)0)
#define trace_xlog_iclog_wait_on(...) ((void)0)
#define trace_xfs_log_umount_write(...) ((void)0)
#define trace_xlog_iclog_write(...) ((void)0)
#define trace_xlog_iclog_sync(...) ((void)0)
#define trace_xlog_iclog_activate(...) ((void)0)
#define trace_xlog_iclog_clean(...) ((void)0)
#define trace_xlog_iclog_callback(...) ((void)0)
#define trace_xlog_iclog_callbacks_start(...) ((void)0)
#define trace_xlog_iclog_callbacks_done(...) ((void)0)
#define trace_xlog_iclog_get_space(...) ((void)0)
#define trace_xfs_log_ticket_regrant(...) ((void)0)
#define trace_xfs_log_ticket_regrant_sub(...) ((void)0)
#define trace_xfs_log_ticket_regrant_exit(...) ((void)0)
#define trace_xfs_log_ticket_ungrant(...) ((void)0)
#define trace_xfs_log_ticket_ungrant_sub(...) ((void)0)
#define trace_xfs_log_ticket_ungrant_exit(...) ((void)0)
#define trace_xlog_iclog_switch(...) ((void)0)
#define trace_xfs_log_force(...) ((void)0)
#define trace_xlog_iclog_force(...) ((void)0)
#define trace_xlog_iclog_force_lsn(...) ((void)0)
#define trace_xfs_log_assign_tail_lsn(...) ((void)0)
#define trace_xlog_iclog_sync_done(...) ((void)0)
