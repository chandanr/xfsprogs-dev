...
extern void	xlog_recover_print_logitem(struct xlog *log, xlog_recover_item_t *item);
...
extern void	xlog_recover_print_trans_head(struct xlog_recover *tr);
extern void	xlog_recover_print_trans(struct xlog *log, struct xlog_recover *trans,
