...
static int	inode_v3_extenthi_count(void *obj, int startoff);
...
const field_t	inode_v3_flds[] = {
	...
	{ "nextents_hi", FLDT_UINT32D, OI(COFF(nextents_hi)), inode_v3_extenthi_count, FLD_COUNT, TYP_NONE },
	{ "naextents_hi", FLDT_UINT16D, OI(COFF(anextents_hi)), inode_v3_extenthi_count, FLD_COUNT, TYP_NONE },
...
static int
inode_v3_extenthi_count(
	void		*obj,
	int		startoff)
{
	return xfs_sb_version_hasextenthi(&mp->m_sb);
}
